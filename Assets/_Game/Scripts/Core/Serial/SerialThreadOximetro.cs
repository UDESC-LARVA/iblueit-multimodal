...
{
    public class SerialThreadOximetro
    {
        ...
        // ------------------------------------------------------------------------
        public SerialThreadOximetro(string portName,
            int baudRate,
            ...
            try
            {
                while (!IsStopRequested())
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        inputQueue.Enqueue(SerialControllerOximetro.SERIAL_DEVICE_DISCONNECTED);
                ...
                {
                    var outputMessage = (string)outputQueue.Dequeue();
        ...
        private void AttemptConnection()
        {
            ...
            inputQueue.Enqueue(SerialControllerOximetro.SERIAL_DEVICE_CONNECTED);
        }
        ...
        private void RunOnce()
        {
            try
            {
                ...
                var inputMessage = serialPort.ReadLine();
