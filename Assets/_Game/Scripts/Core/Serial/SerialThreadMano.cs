...
namespace Ibit.Core.Serial
{
    public class SerialThreadMano
    {
        ...
        // ------------------------------------------------------------------------
        public SerialThreadMano(string portName,
            int baudRate,
            ...
            try
            {
                while (!IsStopRequested())
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        inputQueue.Enqueue(SerialControllerMano.SERIAL_DEVICE_DISCONNECTED);
        ...
        private void AttemptConnection()
        {
            ...
            inputQueue.Enqueue(SerialControllerMano.SERIAL_DEVICE_CONNECTED);
        }
