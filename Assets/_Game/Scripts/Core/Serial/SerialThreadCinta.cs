...
{
    public class SerialThreadCinta
    {
        ...
        // ------------------------------------------------------------------------
        public SerialThreadCinta(string portName,
            int baudRate,
            ...
            try
            {
                while (!IsStopRequested())
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        inputQueue.Enqueue(SerialControllerCinta.SERIAL_DEVICE_DISCONNECTED);
        ...
        private void AttemptConnection()
        {
            ...
            inputQueue.Enqueue(SerialControllerCinta.SERIAL_DEVICE_CONNECTED);
        }
