...
{
    public class SerialThreadPitaco
    {
        ...
        // ------------------------------------------------------------------------
        public SerialThreadPitaco(string portName,
            int baudRate,
            ...
            try
            {
                while (!IsStopRequested())
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        inputQueue.Enqueue(SerialControllerPitaco.SERIAL_DEVICE_DISCONNECTED);
        ...
        private void AttemptConnection()
        {
            ...
            inputQueue.Enqueue(SerialControllerPitaco.SERIAL_DEVICE_CONNECTED);
        }
