...
{
    public partial class CalibrationManagerMano : MonoBehaviour
    {
        public static CalibrationExerciseMano CalibrationToLoad = 0;

        [BoxGroup("Controls")][SerializeField] private CalibrationExerciseMano _currentExercise;
                    ...
                    switch (_currentExercise)
                    {
                        ...
                        case CalibrationExerciseMano.InspiratoryPeak:
                            switch (_currentStep)
                            {
                                ...
                                case 4:
                                    SoundManager.Instance.PlaySound("Success");
                                    DudeTalk($"Seu pico inspiratório é de {ManoFlowMath.ToLitresPerMinute(_tmpCapacities.RawInsPeakFlow):F} L/min." +
                                        " Pressione (Enter) para continuar com os outros exercícios.");
                                    SetupNextStep();
                                    break;
                        ...
                        case CalibrationExerciseMano.ExpiratoryPeak:
                            ...
                            switch (_currentStep)
                            {
                                ...
                                case 4:
                                    SoundManager.Instance.PlaySound("Success");
                                    DudeTalk($"Seu pico expiratório é de {ManoFlowMath.ToLitresPerMinute(_tmpCapacities.RawExpPeakFlow):F} L/min." +
                                        " Pressione (Enter) para continuar com os outros exercícios.");
                                    SetupNextStep();
                                    break;
        ...
        private void AirFlowDisable()
        {
            ...
            _clockObject.GetComponentInChildren<ClockArrowAnimationMano>().SpinClock = false;
        ...
        private void AirFlowEnable(bool restartWatch = true)
        {
            ...
            _clockObject.GetComponentInChildren<ClockArrowAnimationMano>().SpinClock = true;
